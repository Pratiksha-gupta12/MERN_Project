    ...
    <nav className="mt-8 flex-col flex gap-2">
      {adminSidebarMenuItems.map((menuItem) => (
        <div
          ...
          className="flex text-xl cursor-pointer items-center gap-2 rounded-md px-3 py-2 text-muted-foreground 
             hover:bg-muted 
          ...
          <div className="flex flex-col h-full">
            <SheetHeader className="border-b">
              <SheetTitle className="flex gap-2 mt-5 mb-5">
                ...
                <h1 className="text-2xl font-extrabold">Admin Panel</h1>              </SheetTitle>
            </SheetHeader>
